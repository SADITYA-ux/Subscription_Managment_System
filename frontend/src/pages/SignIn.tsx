...
export default function Register() {
    ...
    return (
        <div className="relative min-h-screen overflow-hidden bg-[#0b0b0f] px-4 py-10 sm:px-6">
            ...
            <div className="relative mx-auto flex min-h-[calc(100vh-5rem)] max-w-lg items-center">
